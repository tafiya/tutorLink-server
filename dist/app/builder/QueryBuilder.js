...
exports.tutorSearchableFields = void 0;
exports.tutorSearchableFields = ['name', 'gradeLevel', 'subjects'];
class QueryBuilder {
    ...
    filter() {
        ...
        if (queryObj.subjects)
            filters.subjects = queryObj.subjects;
        if (queryObj.address)
            filters.address = queryObj.address;
        if (queryObj.averageRating)
            filters.averageRating = queryObj.averageRating;
